...
<meta property="og:title" content="Pixel Nourish - Freelance web designer/developer from Central Coast, Australia" />
<meta property="og:description" content="Pixel Nourish is a freelance web designer/developer and photographer from the Central Coast, Australia. It was founded in 2010 and was born from the love of an empty canvas and a clean, crisp CSS stylesheet." />
<meta property="og:image" content="http://pixelnourish.com/wordpress/wp-content/uploads/2012/08/avatar_pixel-nourish.png" />
...
<link rel="stylesheet" href="<?php echo get_bloginfo('template_url'); ?>/css/custom.css" type="text/css" media="screen"/>
    ...
    <script type="text/javascript" src="http://use.typekit.com/ofo8kru.js"></script>
	...
	<div id='wrap_all'>	
			...
			<!-- ####### HEAD CONTAINER ####### -->
				...
				<div class='container_wrap header_color <?php avia_is_dark_bg('header_color'); ?>'>
					...
					if($feedback_button && $contact_page) echo "<a href='".get_permalink($contact_page)."' title='$feedback_button' class='feedback_button' >$feedback_button</a>";
