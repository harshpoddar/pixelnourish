		...
		<!-- ####### SOCKET CONTAINER ####### -->
			<div class='container_wrap socket_color' id='socket'>
				<div class='container'>
                	<span class='copyright' style='padding-bottom:10px;'>
                        &copy; 2010-<?php echo date( 'Y' ); ?>. 
                        All imagery and content are the owner of 
                        <a href='<?php echo home_url('/'); ?>'><?php echo get_bloginfo('name');?></a>, 
                        unless otherwise stated.<br />
                        <a href="http://www.envato.com/" title="Visit Envato">Envato</a>
                        &amp; 
                        <a href="http://pixelnourish.com/out/istockphoto" title="Visit iStockphoto">iStockphoto</a>
                        &copy; their respective owners. Runs using 
                        <a href="http://www.getharvest.com/?r=1ee4fc" title="Try Harvest">Harvest.</a> 
                    </span>
					<!--<span class='copyright'>
                    	&copy; <?php _e('Copyright','avia_framework'); ?> - <a href='<?php echo home_url('/'); ?>'><?php echo get_bloginfo('name');?></a><?php echo $kriesi_at_backlink; ?>
                    </span>-->
